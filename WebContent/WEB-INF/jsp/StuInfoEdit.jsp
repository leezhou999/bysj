...
<link type="text/css" rel="stylesheet"
	...
	<script type="text/javascript"
	src="/bysj/js/student/stuInfoEdit.js"></script>
</head>
<body style="background-color: #e4eef9;">
	<div id="stuInfoEdit" class="easyui-dialog"
		style="width: 420px; height: 450px; left: 33%; top: 40;" title="用户信息编辑">
		<br>
		<center>
			<form id="myform" action="stuInfoEdit"method="post">
				用户编号: <input
				...
				用户性别: <input class="easyui-textbox" id="user_sex" name="user_sex" readonly="true"
					 style="width: 140px" value="${userInfo.user_sex}"><br><br> 
				所属院系: <input class="easyui-textbox" id="deptId" name="deptId" readonly="true"
					 style="width: 140px" value="${userInfo.dName}"><br><br> 
				 所属专业: <input class="easyui-textbox" id="majorId" name="majorId" readonly="true"
					 style="width: 140px" value="${userInfo.majorName}"><br><br> 
				所属班级: <input class="easyui-textbox" id="classesId" name="classesId" readonly="true"
					 style="width: 140px" value="${userInfo.cName}"><br><br> 
