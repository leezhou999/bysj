...
<script type="text/javascript" src="/bysj/js/student/topicResult.js"></script>
<!-- 表头颜色 -->
<style>
...
<body style="background-color: #e4eef9;"style="width:100%;height:563">
