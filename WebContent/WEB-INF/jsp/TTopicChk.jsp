...
<script type="text/javascript" src="/bysj/js/teacher/tTopicChk.js"></script>
<!-- 表头颜色 -->
<style>
...
<div id="cc" class="easyui-layout" style="width:100%;height:563">
   <div data-options="region:'center'" style="width:100%;padding:5px;background:#eee;">  
	...
	<div id="edit" class="easyui-dialog"
		...
		<br>
		<center>
			<form id="editform" action="Admin/chk" method="post">	
				...
				<select class="easyui-combobox" id="chk" name="chk"style="width: 140px">
				 		<option value="6">学生已申请</option>
				 		<option value="1">拒绝选题</option>   
    					<option value="2">同意选题</option>
